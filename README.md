...
Do you want/need to run this course without having to rely on a local machine or cluster? You can click on the Binder link below and this will create an interactive session for you. Please note if you want to save your work during this session you will need to download the relevant notebook file. Everytime this repository changes Binder will also need to re-build an imaghe so it may take longer than usual to load.
